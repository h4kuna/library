...
namespace Invoice;
/**
 * Control - plugin for Nette Framework for generating invoices using mPDF library.
 *
...
class Control extends \Nette\Application\UI\Control {
     ...
     * @param string $title
     */
		public function __construct(\Nette\ComponentModel\IContainer $parent = NULL, $name = NULL, $id = NULL, $title = NULL) {
     ...
     * @return void
     */
    public function setSupplier(IParticipant $supplier) {
     ...
     * @return void
     */
    public function setCustomer(IParticipant $customer) {
    ...
    public function generate() {
        ...
        $template->registerHelper('round', __CLASS__ . '::round');
