...
class Presenter {
    ...
    public function actionGenerate() {
        ...
        $invoice = new Control(date('YmdHis'), 'Faktura - daňový doklad č.');
        ...
        $supplier = new MyParticipant('Jan Vosáhlo', 'Českobratrská', '11', 'Praha 3 - Žižkov', '13000', '12345678', 'CZ12345678', '123456789 / 1111');
        $customer = new MyParticipant('Pepa Pivrnec', 'Někde', '3', 'Praha 9 - Prosek', '19000', '', '', '123456789 / 1111');
        $invoice->setSupplier($supplier);
        $invoice->setCustomer($customer);

        // Definition of Items
        $item = new MyItem('Testovací item 1', 1, 900, 1.19, TRUE);
        $invoice->addItem($item);

        $invoice->addItems(array(
            new MyItem('Testovací item 2', 1, 900, 1.19, TRUE),
            new MyItem('Testovací item 3', 1, 900, 1.19, TRUE),
        ));
